...
import { BreadcrumbLd, ServiceListLd } from "@/components/seo/structured-data";
import { getSite } from "@/lib/data/site";

export const metadata: Metadata = {
  title: "Layanan IT di Semarang — Service PC, CCTV, Website, Jaringan, Server",
  description:
    "Layanan KeeTech Semarang: jasa pembuatan website & aplikasi, service PC & komputer, instalasi CCTV, setup jaringan & server, managed services, AI & chatbot. Melayani Semarang dan sekitarnya.",
  alternates: {
    canonical: "/services",
  },
};
...
export default async function ServicesPage() {
  const [divisions, site] = await Promise.all([getDivisions(), getSite()]);
